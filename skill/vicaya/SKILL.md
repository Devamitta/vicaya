...
**Query construction (rule, not preference):** Search YouTube in **English**. Always include the **Pāḷi sutta name and numeric reference** as anchor terms (e.g. `apannaka sutta MN 60`, `paticcasamuppada dependent origination`). Pāḷi-heavy queries return zero results; long English glosses return zero results. Short and English-anchored wins.
...
Draft the answer in your working notes. Cite as you go — never make a claim without a reference. Citation forms:
...
```
<repo-root>/kamma/threads/20260511_research_hub/runs/<UTC-timestamp>.md
```
